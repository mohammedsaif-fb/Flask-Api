...
# ...
    ...
    query = ("SELECT timestamp as timestamp, stack_height as stack_height, ambient_temp as temps from stack_height sh  WHERE timestamp >= NOW() - INTERVAL 5 MINUTE  order by timestamp desc")

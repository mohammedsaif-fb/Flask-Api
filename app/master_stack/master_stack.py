...
def get_master_stack(groupid, userid, regions):
...
# ...
    ...
    query = ("SELECT timestamp, stack_height, temperature, battery_voltage FROM stack_data WHERE group_id =%s ORDER BY timestamp ASC;")
